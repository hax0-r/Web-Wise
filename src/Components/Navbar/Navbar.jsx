...
import { NAV_DATA, SIGN_IN } from './NAV_DATA';
            ...
            <nav>
                <div className="main">
                    <Link to={NAV_DATA[0].navPath}>
                        <div className="left" onMouseLeave={reverseRotateSVG} onMouseEnter={rotateSVG}>
                            ...
                            <h2 ref={myTextRef}>EZ</h2>
                            <h1 ref={myTextRef} dangerouslySetInnerHTML={{ __html: word }} />
                        </div>
                    </Link>
                    <div className="right">
                        <ul>

            ...
            <div className="footer">
                <div className="main">
                    ...
                    <div className="forth">
                        <h1>Platform</h1>
                        <ul>
                            <li><NavLink> Functions</NavLink></li>
                            <li><NavLink> Tariffs</NavLink></li>
                            <li><NavLink> Partners</NavLink></li>
                            <li><NavLink> Academy</NavLink></li>
                            <li><NavLink> Knowledge base</NavLink></li>
                            <li><NavLink> Popular questions</NavLink></li>
